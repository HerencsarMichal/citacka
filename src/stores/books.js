    ...
    actions: {
        ...
        async loadBookContent(bookId) {
            try {
                ...
                // Súbory v public/ sú dostupné priamo od rootu
                try {
                    ...
                    // Ak fetch zlyhá, vráť knihu bez contentu (použije sa placeholder)
                    console.warn(`Kniha ${book.filename} sa nenašla, použije sa placeholder`)
                    return {
                        ...book,
                        content: null
                    }
